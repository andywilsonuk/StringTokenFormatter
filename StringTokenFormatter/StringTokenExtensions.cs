...
namespace StringTokenFormatter
{
    public static class StringTokenExtensions
    {
        ...
        {
            return new TokenReplacer(TokenReplacer.DefaultMatcher, new FormatProviderValueFormatter(provider)).Format(input, new Dictionary<string, object> { { token, replacementValue } });
        }
        ...
        {
            return new TokenReplacer(TokenReplacer.DefaultMatcher, new FormatProviderValueFormatter(provider)).Format(input, tokenValues);
        }
        ...
        public static string FormatToken(this string input, IFormatProvider provider, IDictionary<string, string> tokenValues)
        {
            ...
            return new TokenReplacer(TokenReplacer.DefaultMatcher, new FormatProviderValueFormatter(provider)).Format(input, tokenValues2);
        }
    }
}
