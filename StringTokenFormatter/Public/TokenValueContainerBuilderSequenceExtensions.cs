...
public static class TokenValueContainerBuilderSequenceExtensions
{
    ...
    public static TokenValueContainerBuilder AddPrefixedSequence<T>(this TokenValueContainerBuilder builder, string prefix, string token, IEnumerable<T> values) where T : notnull =>
        builder.AddPrefixedContainer(prefix, TokenValueContainerFactory.FromSequence(builder.Settings, token, WrapComplexObjects(builder, values)));

    public static TokenValueContainerBuilder AddPrefixedSequence<T>(this TokenValueContainerBuilder builder, string prefix, string token, IEnumerable<ITokenValueContainer> containers) =>
        builder.AddPrefixedContainer(prefix, TokenValueContainerFactory.FromSequence(builder.Settings, token, containers));
